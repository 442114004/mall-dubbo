...
public class OmsPortalOrderServiceImpl implements OmsPortalOrderService {
    ...
    public CommonResult generateOrder(OrderParam orderParam) {
        ...
        Object goods_info =orderParam.getGoodsInfo();
        List<CartPromotionItem> cartPromotionItemList =new ArrayList<>();
        UmsMember currentMember = memberService.getCurrentMember();
        if(!"".equals(goods_info) && goods_info!=null) {
            Map<String, Object> map = JsonUtils.readJsonToMap(goods_info.toString());
     ...
     */
    @Override
    public ConfirmOrderResult ordersubmitpreview(Map<String, Object> params) {
        ...
        if(!"".equals(goods_info) && goods_info!=null && "1".equals(type)) {
            Map<String, Object> map = JsonUtils.readJsonToMap(goods_info.toString());
            Long cartId = Long.valueOf(map.get("cartId").toString());
            OmsCartItem omsCartItem = cartItemService.selectById(cartId);
            List<OmsCartItem> list = new ArrayList<>();
