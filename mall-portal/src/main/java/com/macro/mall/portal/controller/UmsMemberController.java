...
public class UmsMemberController {
    ...
    public Object login(UmsMember umsMember) {
        ...
        String token = memberService.login(umsMember.getUsername(), umsMember.getPassword());
        if (token == null) {
            return new CommonResult().validateFailed("用户名或密码错误");
        }
    ...
    public Object register(@RequestBody UmsMember umsMember) {
        return memberService.register(umsMember.getUsername(), umsMember.getPassword(), umsMember.getPhone(), umsMember.getCode());
    }
